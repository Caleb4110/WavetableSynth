...
{
    return {
        std::make_unique<juce::AudioParameterFloat>("cutoff", "Cutoff", juce::NormalisableRange{20.f, 20000.f, 0.1f, 0.2f, false}, 500.f),
    };
}
...
#endif
    , parameters (*this, nullptr, juce::Identifier ("APVTSTutorial"), createParameterLayout())
{
    cutoffFrequencyParameter = parameters.getRawParameterValue("cutoff");
}
...
void WavetableSynthAudioProcessor::updateSynthWaveform(int tableNumber)
{
    synth.initialiseOscillators(tableNumber);
}
